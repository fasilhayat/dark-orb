...
//   5 = Mage        6 = Bard     7 = Druid     8 = Fighter   9 = Rogue
//
// Group shortcuts:
...
public static class ArchetypeWeaponExtensions
{
    ...
    private static readonly Dictionary<ArchetypeWeapon, HashSet<int>> _allowedClasses = new()
    {
        ...
        // Spears: broad melee weapon — warriors, bard, druid.
        [ArchetypeWeapon.Spear]      = [1, 2, 3, 6, 7, 8],
        ...
        // ── Ranged ───────────────────────────────────────────────────────────
        // Bows: warriors and rogues. Divine casters prefer slings.
        [ArchetypeWeapon.Bow]        = [1, 2, 3, 6, 8, 9],

        // Crossbows: same as bows (mechanical, so Druids skip).
        [ArchetypeWeapon.Crossbow]   = [1, 2, 3, 6, 8, 9],
