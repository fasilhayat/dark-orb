...
public class CombatantStats
{
    ...
    /// </summary>
    public int DefensePower => EffectiveAC + DexterityModifier + ShieldBonus + DefensiveBuffs + DefenseRacialModifiers + DefenseItemSetBonuses + MagicResistanceBonus + LevelDefenseBonus;
}
