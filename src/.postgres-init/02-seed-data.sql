...
FROM (VALUES
    ...
    ('Aegis', 'D4', 'None', 'None', 'Armor',                   5, 60, 1, 0, 0, 0, 'None',     1, 'Magical armor that improves survivability.  Tags: Defensive, Buff'),
    ('Aegis', 'D4', 'None', 'None', 'Shield',                  5, 60, 1, 0, 0, 0, 'None',     1, 'Magical shield against attacks and missiles.  Tags: Defensive'),
    ('Stormcraft', 'D4', 'Fire', 'Melee', 'Burning Hands',     10, 60, 1, 1, 2, 0, 'Fire',     1, 'Short cone of flame that scorches nearby enemies.  Tags: Offensive, AoE'),
    ('Mirage', 'D4', 'None', 'Ranged', 'Grease',                 8, 60, 1, 0, 0, 0, 'None',     1, 'Slippery coating that causes falls and handling failure.  Tags: CC, Slip, AoE'),
    ('Mirage', 'D4', 'None', 'Ranged', 'Sleep',                  8, 60, 1, 0, 0, 0, 'None',     1, 'Puts weaker targets into magical sleep.  Tags: CC, AoE'),
    ('Mirage', 'D4', 'None', 'Melee', 'Color Spray',            8, 60, 1, 0, 0, 0, 'Light',    1, 'Cone of sensory overload that blinds, stuns, or drops weak targets.  Tags: CC, AoE'),
    ('Mirage', 'D4', 'None', 'None', 'Detect Magic',           5, 60, 1, 0, 0, 0, 'None',     1, 'Reveals magical auras and enchantments.  Tags: Utility'),
    ('Mirage', 'D4', 'None', 'None', 'Invisibility',          12, 70, 2, 0, 0, 0, 'None',     2, 'Makes a target unseen until broken.  Tags: Invisibility'),
    ('Mirage', 'D4', 'None', 'None', 'Mirror Image',          12, 70, 2, 0, 0, 0, 'None',     2, 'Creates illusory duplicates to absorb attacks.  Tags: Defensive, Image'),
    ('Dominion', 'D4', 'None', 'Ranged', 'Web',                 15, 70, 2, 0, 0, 0, 'None',     2, 'Sticky strands trap and hinder enemies.  Tags: CC, Root, AoE'),
    ('Mirage', 'D4', 'Poison', 'Ranged', 'Stinking Cloud',      15, 70, 2, 0, 0, 0, 'Poison',   2, 'Nauseating cloud that disrupts actions.  Tags: CC, AoE'),

    -- Mage Specialization (level 3+)
    ('Stormcraft', 'D6', 'Lightning', 'Ranged', 'Lightning Bolt',    25, 80, 3, 3, 2, 0, 'Lightning', 4, 'Straight-line lightning blast through enemies.  Tags: Offensive, AoE, Nuke'),
    ('Stormcraft', 'D6', 'Fire', 'Ranged', 'Fireball',               30, 90, 3, 3, 2, 0, 'Fire',      4, 'Explosive ranged fire burst for clustered targets.  Tags: Offensive, AoE, Nuke'),
    ('Mirage', 'D4', 'None', 'None', 'Blink',                     20, 80, 3, 0, 0, 0, 'None',      4, 'Phasing displacement defense.  Tags: Blink, Defensive'),
    ('Dominion', 'D4', 'None', 'Ranged', 'Slow',                    20, 80, 3, 0, 0, 0, 'None',      4, 'Reduces enemy tempo and action efficiency.  Tags: CC, Debuff, Turn-Meter Control'),
    ('Dominion', 'D4', 'None', 'None', 'Haste',                   20, 70, 3, 0, 0, 0, 'None',      5, 'Accelerates a target, massively increasing turn meter gain for a short duration.  Tags: Buff, TM Uplift'),
    ('Dominion', 'D4', 'None', 'None', 'Mass Haste',              35, 90, 5, 0, 0, 0, 'None',      7, 'Accelerates all party members, boosting turn meter gain.  Inflicts Haste Fatigue on the caster.  Tags: Buff, TM Uplift, Group'),
    ('Umbramancy', 'D8', 'Shadow', 'Melee', 'Vampiric Touch',      25, 80, 3, 2, 2, 0, 'Shadow',    4, 'Melee life-drain spell that steals vitality.  Tags: Single-Target Damage, Leech'),
    ('Umbramancy', 'D4', 'None', 'Ranged', 'Fear',                  22, 80, 4, 0, 0, 0, 'Shadow',    5, 'Sends enemies fleeing in panic.  Tags: CC, Debuff'),
    ('Stormcraft', 'D6', 'Ice', 'Ranged', 'Ice Storm',              35, 90, 4, 4, 2, 0, 'Ice',       5, 'Area storm of cold and impact force.  Tags: Offensive, AoE'),
    ('Mirage', 'D4', 'None', 'Ranged', 'Confusion',                 30, 90, 4, 0, 0, 0, 'None',      6, 'Scrambles enemy behavior and target selection.  Tags: CC, AoE'),
    ('Umbramancy', 'D6', 'Poison', 'Ranged', 'Cloudkill',           40, 100, 5, 4, 2, 0, 'Poison',    7, 'Expanding poisonous cloud.  Tags: Offensive, AoE'),
    ('Stormcraft', 'D6', 'Ice', 'Ranged', 'Cone of Cold',           40, 100, 5, 5, 2, 0, 'Ice',       7, 'Heavy cone-shaped cold burst.  Tags: Offensive, AoE, Nuke'),
    ('Umbramancy', 'D4', 'None', 'Ranged', 'Feeblemind',            35, 100, 5, 0, 0, 0, 'None',      7, 'Cripples caster or intellectual function.  Tags: CC, Anti-Mage'),
    ('Stormcraft', 'D6', 'Fire', 'Ranged', 'Delayed Blast Fireball',50, 110, 7, 5, 3, 0, 'Fire',      9, 'Timed explosive fire spell.  Tags: Offensive, AoE, Nuke'),
    ('Mirage', 'D4', 'None', 'Ranged', 'Maze',                      45, 120, 8, 0, 0, 0, 'None',      10, 'Temporarily removes a target from the battlefield.  Tags: CC'),

    -- Mage variants
    ('Umbramancy', 'D4', 'Shadow', 'Ranged', 'Mind Siphon',         25, 80, 4, 0, 2, 0, 'Shadow',    5, 'Dark anti-mage variant that drains magical reserves.  Tags: MP Leech, Variant'),
    ('Stormcraft', 'D6', 'Lightning', 'Melee', 'Arc Lash',         25, 80, 3, 2, 2, 0, 'Lightning', 4, 'Focused lightning lash that shocks one target.  Tags: Single-Target Damage, TM Control, Variant'),
    ('Mirage', 'D4', 'None', 'None', 'Mirror Guard',              22, 80, 3, 0, 0, 0, 'None',      4, 'Advanced mirror-image ward with partial retaliation.  Tags: Defensive, Variant'),
    ('Stormcraft', 'D6', 'Fire', 'Melee', 'Greasefire',            20, 75, 2, 2, 2, 0, 'Fire',      3, 'Ignites a grease field into a burning slick.  Tags: Offensive, AoE, Variant'),

    -- Legacy roster spells (mapped to new schools)
    ('Stormcraft', 'D8', 'Ice', 'Ranged', 'Ice Bolt',               35, 80, 2, 2, 2, 0, 'Ice',       3, 'A bolt of ice that freezes the target.  Tags: Single-Target Damage'),
    ('Stormcraft', 'D6', 'Lightning', 'Ranged', 'Shock',            20, 75, 2, 2, 2, 0, 'Lightning', 3, 'A jolt of electrical energy.  Tags: Single-Target Damage'),
    ('Stormcraft', 'D6', 'Lightning', 'Ranged', 'Static Shock',     30, 80, 2, 1, 2, 0, 'Lightning', 3, 'A charged static shock that leaves lasting effects.  Tags: Single-Target Damage, Debuff'),

    -- Priest spells (Deity school)
    ('Deity', 'D4', 'None', 'None', 'Bless',                     10, 60, 1, 0, 0, 0, 'None',     1, 'Improves ally morale and combat performance.  Tags: Buff, AoE'),
    ('Deity', 'D4', 'None', 'Ranged', 'Command',                   10, 60, 1, 0, 0, 0, 'None',     1, 'One-word forced action disrupting the target.  Tags: CC'),
    ('Deity', 'D4', 'Healing', 'Melee', 'Cure Light Wounds',     15, 60, 1, 1, 0, 4, 'None',     1, 'Basic divine healing.  Tags: Healing'),
    ('Deity', 'D4', 'None', 'None', 'Protection from Evil',     10, 60, 1, 0, 0, 0, 'None',     1, 'Defensive ward against evil influence.  Tags: Defensive, Buff'),
    ('Deity', 'D4', 'None', 'Ranged', 'Chasten',                  10, 60, 1, 0, 0, 0, 'None',     1, 'Weakens sinful and hostile targets.  Tags: Debuff'),
    ('Deity', 'D4', 'None', 'None', 'Sanctuary',                10, 60, 1, 0, 0, 0, 'None',     1, 'Makes hostile creatures less likely to attack.  Tags: Defensive'),
    ('Deity', 'D4', 'None', 'None', 'Aid',                      15, 70, 2, 0, 0, 0, 'None',     3, 'Supportive blessing that improves staying power.  Tags: Buff'),
    ('Deity', 'D4', 'None', 'None', 'Chant',                    15, 70, 2, 0, 0, 0, 'None',     3, 'Battlefield prayer that aids allies and hinders enemies.  Tags: Buff, Debuff'),
    ('Deity', 'D4', 'None', 'Ranged', 'Hold Person',              18, 70, 2, 0, 0, 0, 'None',     4, 'Paralyzes humanoid targets.  Tags: CC'),
    ('Deity', 'D4', 'None', 'None', 'Prayer',                   20, 80, 3, 0, 0, 0, 'None',     5, 'Broad ally buff plus enemy penalty effect.  Tags: Buff, Debuff'),
    ('Deity', 'D4', 'None', 'Melee', 'Remove Paralysis',         12, 70, 3, 0, 0, 0, 'None',     5, 'Frees allies from paralysis.  Tags: Healing, Cleanse'),
    ('Deity', 'D4', 'Healing', 'Melee', 'Cure Serious Wounds',   25, 80, 4, 2, 0, 8, 'None',     6, 'Stronger direct healing.  Tags: Healing'),
    ('Deity', 'D4', 'None', 'None', 'Free Action',              18, 80, 4, 0, 0, 0, 'None',     6, 'Prevents many movement-impairing effects.  Tags: Defensive'),
    ('Deity', 'D4', 'Healing', 'Melee', 'Cure Critical Wounds',  35, 90, 5, 2, 0, 12, 'None',    7, 'Large heal for severe injuries.  Tags: Healing'),
    ('Deity', 'D6', 'Fire', 'Ranged', 'Flame Strike',             30, 90, 5, 3, 2, 0, 'Fire',      7, 'Vertical divine column of holy fire.  Tags: Offensive, Nuke'),
    ('Deity', 'D8', 'Healing', 'Melee', 'Heal',                  25, 80, 6, 2, 0, 12, 'None',     8, 'Major restorative miracle.  Tags: Healing'),
    ('Deity', 'D6', 'Physical', 'Ranged', 'Blade Barrier',        35, 100, 6, 4, 2, 0, 'None',     8, 'Wall or ring of whirling blades.  Tags: Offensive, Defensive, Barrier'),
    ('Deity', 'D4', 'None', 'None', 'Heroes Feast',             40, 100, 6, 0, 0, 0, 'None',     8, 'Group pre-battle meal with strong support benefits.  Tags: Buff, AoE'),
    ('Deity', 'D4', 'None', 'Melee', 'Restoration',              30, 90, 7, 0, 0, 0, 'None',     9, 'Repairs severe spiritual or life-force harm.  Tags: Healing, Cleanse'),

    -- Druid spells
    ('Deity', 'D4', 'None', 'Ranged', 'Entangle',                 10, 60, 1, 0, 0, 0, 'None',     1, 'Plants twist around creatures and restrain them.  Tags: CC, Root'),
    ('Deity', 'D4', 'None', 'Ranged', 'Faerie Fire',              10, 60, 1, 0, 0, 0, 'None',     1, 'Outlines targets, countering stealth.  Tags: Debuff'),
    ('Deity', 'D4', 'Physical', 'None', 'Shillelagh',            5, 60, 1, 0, 2, 0, 'None',     1, 'Enchants a club or staff to hit harder.  Tags: Buff'),
    ('Deity', 'D4', 'None', 'None', 'Barkskin',                 15, 70, 2, 0, 0, 0, 'None',     3, 'Skin becomes as tough as bark.  Tags: Defensive'),
    ('Deity', 'D4', 'Healing', 'None', 'Goodberry',             12, 70, 2, 1, 0, 4, 'None',     3, 'Creates restorative berries.  Tags: Healing'),
    ('Deity', 'D4', 'Fire', 'Ranged', 'Heat Metal',              15, 70, 2, 1, 2, 0, 'Fire',      3, 'Punishes armored enemies through heat.  Tags: Debuff'),
    ('Deity', 'D6', 'Lightning', 'Ranged', 'Call Lightning',      25, 80, 3, 3, 2, 0, 'Lightning', 5, 'Repeated lightning strikes from a storm.  Tags: Offensive'),
    ('Deity', 'D4', 'None', 'Ranged', 'Hold Animal',              18, 70, 3, 0, 0, 0, 'None',     5, 'Immobilizes beasts.  Tags: CC'),
    ('Deity', 'D4', 'None', 'None', 'Call Woodland Beings',    25, 80, 4, 0, 0, 0, 'None',     6, 'Summons nature spirits or woodland allies.  Tags: Summoning'),
    ('Deity', 'D4', 'Physical', 'None', 'Giant Insect',         25, 80, 4, 2, 2, 0, 'None',     6, 'Enlarges vermin into combat-capable forms.  Tags: Summoning-lite'),
    ('Deity', 'D4', 'Poison', 'Ranged', 'Insect Plague',          35, 90, 5, 3, 2, 0, 'Poison',    7, 'Swarming insects disrupt and overwhelm groups.  Tags: Offensive, CC'),
    ('Deity', 'D4', 'None', 'None', 'Anti-Plant Shell',        25, 80, 5, 0, 0, 0, 'None',     7, 'Prevents plant creatures from closing in.  Tags: Defensive'),
    ('Deity', 'D6', 'Fire', 'Ranged', 'Fire Seeds',              35, 90, 6, 4, 2, 0, 'Fire',      8, 'Druid explosive seeds used as bombs or traps.  Tags: Offensive'),
    ('Deity', 'D4', 'Physical', 'None', 'Liveoak',              40, 100, 6, 0, 0, 0, 'None',     8, 'Awakens a great tree guardian.  Tags: Summoning'),
    ('Deity', 'D4', 'Physical', 'Ranged', 'Creeping Doom',        45, 100, 7, 4, 2, 0, 'Poison',    9, 'Devastating moving swarm.  Tags: Offensive, CC'),
    ('Deity', 'D6', 'Physical', 'Ranged', 'Earthquake',           45, 110, 7, 5, 2, 0, 'None',     9, 'Wide-area terrain disruption.  Tags: Offensive, AoE'),

    -- Paladin spells
    ('Deity', 'D4', 'None', 'None', 'Remove Fear',              10, 60, 1, 0, 0, 0, 'None',     6, 'Clears fear and bolsters courage.  Tags: Buff, Cleanse'),
    ('Deity', 'D8', 'Holy', 'None', 'Smite',                    35, 80, 2, 2, 2, 0, 'None',     6, 'Divine strike against enemies.  Tags: Offensive'),
    ('Deity', 'D4', 'None', 'None', 'Resist Fire',              12, 70, 2, 0, 0, 0, 'Fire',     7, 'Grants fire resistance.  Tags: Defensive'),
    ('Deity', 'D4', 'None', 'None', 'Resist Cold',              12, 70, 2, 0, 0, 0, 'Ice',      7, 'Grants cold resistance.  Tags: Defensive'),
    ('Deity', 'D4', 'None', 'None', 'Magical Vestment',         18, 80, 3, 0, 0, 0, 'None',     8, 'Enhances armor or shield with divine power.  Tags: Buff, Defensive'),
    ('Deity', 'D4', 'None', 'None', 'Protection from Evil 10ft',20, 80, 4, 0, 0, 0, 'None',     9, 'Group protection aura against evil.  Tags: Defensive, AoE'),
    ('Deity', 'D4', 'None', 'None', 'Holy Bulwark',             25, 80, 4, 0, 0, 0, 'None',     10, 'Elite paladin ward for nearby allies.  Tags: Defensive, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Paladin Warcry',           20, 80, 3, 0, 0, 0, 'None',     9, 'Inspiring holy battle-cry that rallies allies.  Tags: Buff, AoE, Variant'),

    -- Knight spells
    ('Deity', 'D4', 'None', 'None', 'War Cry',                  15, 70, 1, 0, 0, 0, 'None',     9, 'Battle shout that shocks enemies or steels allies.  Tags: CC or Buff, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Rallying Cry',             15, 70, 1, 0, 0, 0, 'None',     9, 'Calls allies back into formation.  Tags: Buff, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Steadfast Line',           18, 75, 2, 0, 0, 0, 'None',     10, 'Reinforces discipline and formation stability.  Tags: Buff, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Banner of Resolve',        18, 75, 2, 0, 0, 0, 'None',     10, 'Banner magic that hardens allied will.  Tags: Buff, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Iron Will Litany',         22, 80, 3, 0, 0, 0, 'None',     11, 'Litany of discipline against hostile magic.  Tags: Defensive, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Advance Signal',           20, 80, 3, 0, 0, 0, 'None',     11, 'Tactical call to press the attack.  Tags: Buff, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Shielding Cadence',        22, 80, 3, 0, 0, 0, 'None',     12, 'Rhythmic command that improves survival.  Tags: Defensive, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Battle Hymn of Defiance', 30, 90, 4, 0, 0, 0, 'None',     12, 'Powerful morale chant for large engagements.  Tags: Buff, AoE, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Arcane Defiance Banner',  30, 90, 4, 0, 0, 0, 'None',     13, 'Elite banner ward against sorcery.  Tags: Defensive, Variant'),
    ('Deity', 'D4', 'None', 'None', 'Lionheart Command',        35, 100, 4, 0, 0, 0, 'None',     13, 'Supreme command that hardens allied resolve.  Tags: Buff, Variant'),

    -- Legacy roster spells (continued)
    ('Deity', 'D6', 'Healing', 'Ranged', 'Mass Heal',             50, 100, 4, 3, 0, 6, 'None',     7, 'Powerful group healing spell.  Tags: Healing, AoE'),
    ('Umbramancy', 'D4', 'Shadow', 'Ranged', 'Mind Game',         25, 80, 2, 1, 0, 0, 'Shadow',    3, 'Confuses the target, causing erratic behavior.  Tags: CC, Debuff'),
    ('Mirage', 'D4', 'None', 'Ranged', 'Charm Person',            30, 80, 2, 0, 0, 0, 'None',     3, 'Charms a humanoid to fight as an ally.  Tags: CC, Charm'),
    ('Deity', 'D6', 'Holy', 'Ranged', 'Turn Undead',              25, 80, 2, 2, 2, 0, 'Holy',     3, 'Drives undead enemies away in fear.  Tags: Offensive, CC'),

    -- Additional common spells (migrated from quick-reference index; levels are preliminary)
    ('Stormcraft', 'D10', 'Fire', 'Ranged', 'Fire Storm',       12, 70, 2, 1, 2, 0, 'Fire',      1, 'A conflagration engulfs the area.  Tags: Offensive, AoE, Nuke'),
    ('Stormcraft', 'D6',  'Acid', 'Ranged', 'Acid Rain',         9, 65, 2, 1, 2, 0, 'Acid',      1, 'Corrosive rain burns all in the area.  Tags: Offensive, AoE'),
    ('Stormcraft', 'D12', 'Fire', 'Ranged', 'Lava Hail',        15, 75, 3, 1, 2, 0, 'Fire',      1, 'Molten rock rains from the sky.  Tags: Offensive, AoE, Nuke'),
    ('Stormcraft', 'D10', 'Lightning', 'Ranged', 'Lightning Strike', 10, 70, 2, 1, 2, 0, 'Lightning', 1, 'A bolt of lightning strikes from above.  Tags: Offensive, AoE'),
    ('Verdancy',   'D6',  'Bludgeoning', 'Ranged', 'Sand Storm',        7, 65, 2, 1, 2, 0, 'None',      1, 'Blinding sand scours the battlefield.  Tags: Offensive, AoE'),
    ('Verdancy',   'D4',  'Piercing', 'Ranged', 'Insect Swarm',      7, 65, 2, 1, 2, 0, 'None',      1, 'A cloud of biting insects descends.  Tags: Offensive, DoT'),
    ('Mirage',     'D4',  'None', 'Ranged', 'Blinding Flash',    6, 65, 1, 0, 0, 0, 'None',      1, 'A brilliant flash blinds all who see it.  Tags: CC, AoE'),
    ('Umbramancy', 'D4',  'None', 'Ranged', 'Fog of Despair',    8, 70, 2, 0, 0, 0, 'Shadow',    1, 'A choking fog that saps morale.  Tags: CC, AoE'),
    ('Stormcraft', 'D4',  'None', 'Ranged', 'Stun',              5, 60, 1, 0, 0, 0, 'None',      1, 'A concussive force that stuns the target.  Tags: CC'),
    ('Stormcraft', 'D4',  'None', 'Ranged', 'Freeze',            7, 65, 1, 0, 0, 0, 'Ice',       1, 'Encases the target in ice.  Tags: CC'),
    ('Mirage',     'D4',  'None', 'Ranged', 'Charm Enemy',       8, 65, 2, 0, 0, 0, 'None',      1, 'Bends an enemy to your will.  Tags: CC'),
    ('Mirage',     'D4',  'None', 'Ranged', 'Confuse',           6, 65, 1, 0, 0, 0, 'None',      1, 'Makes the target act erratically.  Tags: CC'),
    ('Mirage',     'D4',  'None', 'Ranged', 'Blind',             5, 60, 1, 0, 0, 0, 'None',      1, 'Robs the target of sight.  Tags: CC'),
    ('Dominion',   'D4',  'None', 'Ranged', 'Taunt',             4, 60, 1, 0, 0, 0, 'None',      1, 'Forces an enemy to attack you.  Tags: CC'),
