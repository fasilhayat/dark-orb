...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ...
    ('Humanoid', 'Goblin', 2, 0, 1, 0, 0, -1, -1, 10, 9,
    ...
    ('Humanoid', 'Greater Goblin', 3, 1, 1, 1, 0, 0, -1, 18, 8,
     '+2, 1D6+1 (scimitar)',
    ...
    ('Humanoid', 'Kobold', 2, 0, 2, 0, 1, 0, -1, 9, 9,
    ...
    ('Humanoid', 'Greater Kobold', 3, 0, 2, 0, 1, 1, 0, 14, 8,
    ...
    ('Humanoid', 'Lesser Orc', 3, 2, 1, 1, 0, 0, -1, 18, 8,
     '+3, 1D8+2 (battle axe)',
    ...
    ('Humanoid', 'Orc', 5, 3, 0, 2, 0, 0, -1, 30, 7,
     '+5, 1D10+3 (greataxe)',
    ...
    ('Humanoid', 'Greater Orc', 8, 4, 1, 3, 1, 1, 0, 55, 5,
    ...
    ('Humanoid', 'Dark Elf Scout', 5, 0, 3, 0, 1, 1, 1, 22, 6,
    ...
    ('Humanoid', 'Dark Elf Mage', 7, 0, 2, 0, 3, 1, 2, 28, 6,
    ...
    ('Humanoid', 'Greater Dark Elf', 9, 1, 2, 1, 3, 2, 3, 42, 4,
    ...
    ('Humanoid', 'Elven Archer', 3, 0, 2, 0, 1, 1, 1, 14, 8,
    ...
    ('Humanoid', 'Elven Mage', 6, 0, 2, 0, 3, 1, 2, 22, 7,
     '+5, 1D4 (arcane staff)',
    ...
    ('Humanoid', 'Elven Lord', 9, 2, 3, 1, 2, 2, 3, 40, 3,
    ...
    ('Humanoid', 'Lesser Lizard', 3, 2, 1, 1, 0, 0, -1, 16, 9,
     '+2, 1D6+2 (stone club)',
    ...
    ('Humanoid', 'Lizard Warrior', 5, 2, 1, 2, 0, 1, 0, 28, 7,
    ...
    ('Humanoid', 'Greater Lizard', 8, 2, 1, 2, 1, 3, 1, 40, 6,
     '+5, 1D8+2 (bone staff)',
    ...
    ('Humanoid', 'Mercenary', 3, 1, 1, 1, 0, 0, 0, 18, 8,
    ...
    ('Humanoid', 'Knight', 6, 2, 1, 2, 0, 1, 1, 38, 4,
    ...
    ('Humanoid', 'Captain', 9, 3, 2, 2, 2, 1, 2, 55, 3,
    ...
    ('Humanoid', 'Dwarf Warrior', 3, 2, 0, 2, 0, 1, 0, 22, 8,
    ...
    ('Humanoid', 'Dwarf Berserker', 5, 3, 0, 3, 0, 1, -1, 38, 7,
     '+5, 1D10+3 (greataxe)',
    ...
    ('Humanoid', 'Dwarf Lord', 8, 3, 1, 3, 1, 2, 1, 58, 4,
    ...
    ('Humanoid', 'Gladefolk Prowler', 2, 0, 2, 1, 0, 1, 1, 10, 9,
    ...
    ('Humanoid', 'Gladefolk Slinger', 4, 0, 3, 1, 1, 1, 1, 16, 7,
    ...
    ('Humanoid', 'Gladefolk Elder', 6, 0, 3, 2, 1, 2, 2, 28, 5,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Beast', 'Giant Rat', 1, -1, 2, 0, -3, -1, -3, 5, 11,
     '+1, 1D4 (bite)',
    ...
    ('Beast', 'Giant Spider', 3, 1, 2, 1, -2, 0, -3, 14, 8,
     '+3, 1D6+1 (bite) + poison',
    ...
    ('Beast', 'Dire Wolf', 4, 2, 2, 2, -2, 1, -2, 22, 7,
     '+4, 1D10+2 (bite)',
    ...
    ('Beast', 'Great Stag', 6, 2, 3, 2, 2, 2, 1, 35, 6,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Monstrosity', 'Lesser Ogre', 5, 3, 0, 2, -2, -1, -1, 35, 8,
     '+4, 2D6+3 (huge club)',
    ...
    ('Monstrosity', 'Ogre', 7, 4, 0, 3, -2, -1, -1, 50, 6,
     '+6, 2D8+4 (greatclub)',
    ...
    ('Monstrosity', 'Greater Ogre', 10, 5, 0, 4, -1, 0, 0, 80, 4,
    ...
    ('Monstrosity', 'Forest Troll', 7, 3, 1, 3, -1, 0, -2, 45, 6,
    ...
    ('Monstrosity', 'Cave Troll', 9, 4, 1, 4, -1, 0, -2, 65, 5,
    ...
    ('Monstrosity', 'Mountain Troll', 10, 5, 0, 5, -1, 1, -2, 80, 4,
     '+8, 2D8+5 (rocky fists)',
    ...
    ('Monstrosity', 'Hill Giant', 10, 5, 0, 4, -2, 0, -1, 75, 4,
    ...
    ('Monstrosity', 'Stone Giant', 11, 5, 1, 5, 0, 1, 0, 90, 2,
    ...
    ('Monstrosity', 'Frost Giant', 12, 6, 0, 5, 1, 1, 1, 105, 0,
    ...
    ('Monstrosity', 'Minotaur', 7, 4, 1, 3, -1, 0, -1, 52, 6,
    ...
    ('Monstrosity', 'Harpy', 5, 0, 3, 1, 0, 1, 0, 20, 7,
    ...
    ('Monstrosity', 'Basilisk', 9, 3, 1, 3, -1, 2, -2, 60, 4,
     '+7, 2D8+3 (bite)',
    ...
    ('Monstrosity', 'Chimera', 11, 5, 2, 4, -1, 1, 0, 85, 2,
    ...
    ('Monstrosity', 'Centaur Archer', 5, 2, 3, 2, 0, 1, 0, 28, 7,
    ...
    ('Monstrosity', 'Centaur Chieftain', 8, 3, 3, 3, 1, 2, 1, 45, 5,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Undead', 'Skeleton', 1, 0, 1, 0, -2, -1, -2, 8, 8,
    ...
    ('Undead', 'Ghoul', 3, 1, 2, 1, -1, 0, -2, 15, 9,
     '+3, 1D6+1 (claw)',
    ...
    ('Undead', 'Draugr', 6, 3, 0, 2, 0, 0, -1, 40, 6,
    ...
    ('Undead', 'Wight', 5, 2, 1, 1, 1, 1, 0, 32, 6,
    ...
    ('Undead', 'Mummy', 9, 3, 0, 3, 1, 2, 1, 55, 4,
    ...
    ('Undead', 'Lich', 12, 1, 1, 2, 4, 3, 2, 85, 0,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ...
    ('Spirit', 'Poltergeist', 5, 0, 2, 0, 0, 1, 0, 18, 8,
    ...
    ('Spirit', 'Banshee', 8, 0, 2, 0, 1, 2, 3, 30, 5,
    ...
    ('Spirit', 'Wraith', 8, 0, 3, 0, 2, 2, 1, 45, 4,
    ...
    ('Spirit', 'Ancestral Guardian', 10, 2, 1, 2, 1, 3, 2, 45, 3,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Demon', 'Lesser Demon', 8, 1, 3, 1, 1, 0, 0, 28, 5,
    ...
    ('Demon', 'Demon', 10, 3, 2, 3, 2, 1, 1, 55, 3,
    ...
    ('Demon', 'Greater Demon', 12, 4, 3, 4, 3, 2, 3, 85, 0,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Construct', 'Clay Golem', 8, 4, -2, 4, -3, -2, -3, 50, 4,
     '+6, 1D10+4 (slam)',
    ...
    ('Construct', 'Iron Golem', 10, 5, -1, 5, -3, -2, -3, 70, 2,
    ...
    ('Construct', 'Adamantite Golem', 12, 6, -1, 6, -3, -2, -3, 100, -1,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Dragon', 'Wyrmling', 10, 3, 2, 3, 2, 2, 2, 60, 2,
    ...
    ('Dragon', 'Adult Dragon', 12, 5, 2, 5, 3, 3, 4, 100, -2,
    ...
    ('Dragon', 'Ancient Dragon', 12, 7, 2, 6, 5, 4, 5, 150, -4,
...
INSERT INTO arena_data.bestiary (category, name, level, strength_bonus, dexterity_bonus, stamina_bonus, intelligence_bonus, wisdom_bonus, charisma_bonus, max_hit_points, armor_class, attack_description, special_abilities, description) VALUES
    ('Celestial', 'Valkyrie', 11, 4, 3, 3, 2, 3, 4, 65, 1,
