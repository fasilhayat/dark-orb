...
1. [Humanoids](#1-humanoids)
2. [Beasts](#2-beasts)
3. [Monstrosities](#3-monstrosities)
4. [Undead](#4-undead)
5. [Spirits & Ghosts](#5-spirits--ghosts)
6. [Demons](#6-demons)
7. [Constructs](#7-constructs)
8. [Dragons](#8-dragons)
9. [Celestials](#9-celestials)
10. [Fey](#10-fey)
...
Playable races and their kin — bandits, soldiers, raiders, and reavers. Humanoids make up the bulk of low- to mid-level opponents.

### 1.1 Goblins

Small, green-skinned nuisances that infest caves and ruins. Cowardly alone, dangerous in numbers.
...
|------|-|
| Level | 1 |
| STR/DEX/CON/INT/WIS/CHA | +0 / +1 / +0 / -1 / -1 / -1 |
| Max HP | 6 |
| AC | 10 |
| Attack | +0, 1D4 (rusty dagger) |
...
Small, scaly tunnel-dwellers with sharp cunning and magic resistance.
...
| Max HP | 5 |
| AC | 10 |
| Attack | +0, 1D4 (rusty spear) |
| Special | **Magic Resistance** — advantage on saves vs. magical effects.<br>**Tunnel Rat** — does not provoke opportunity attacks when moving through narrow terrain. |
...
The Chosen of the War God — bred for battle, hardened by endless conflict.

#### Lesser Orc (Orc Scout)
...
Elves of the underdark, twisted by centuries of shadow and intrigue.
...
### 1.5 Elves (High Elf, Forest Elf)

Children of the Moon goddess — graceful, long-lived, and deeply connected to magic. Elven opponents are precise, swift, and fight with a elegance that borders on art.

#### Elven Archer (Lesser Elf)
...
### 1.6 Lizardfolk (Descendants of Lesser Dragons)

Scales shimmer with draconic heritage. Cold, patient, and utterly without mercy.

#### Lesser Lizard (Lizard Scout)
...
The most adaptable race. Human opponents take many forms — bandits, mercenaries, knights, and commanders.
...
|------|-|
| Level | 1 |
| STR/DEX/CON/INT/WIS/CHA | +1 / +1 / +0 / +0 / +0 / +0 |
| Max HP | 8 |
| AC | 10 |
| Attack | +1, 1D6 (short sword) or +1, 1D4 (sling, ranged) |
| Special | None |
...
Small in stature, immense in courage. Standing no taller than a human child of thirteen, even their elders look like youths to other races — a deception that has cost many invaders dearly. Gladefolk opponents are fast, lucky, and irritatingly hard to pin down.

#### Gladefolk Prowler (Lesser Gladefolk)
...
#### Gladefolk Slinger (Gladefolk Skirmisher)
...
#### Gladefolk Elder (Greater Gladefolk)
...
Natural animals and their giant variants. Beasts rely on instinct, fang, and claw rather than tactics or magic.

### 2.1 Giant Rat (Lesser Beast)
...
*Inspired by the monstrous wolves of Norse myth — larger, meaner, and hungrier than any natural wolf.*
...
True monsters — unnatural hybrids, mythological beasts, and creatures that defy easy classification. These are the things that haunt the wild places of the world.

### 3.1 Ogres

Titans diminished by age, but still mighty beyond measure.

#### Lesser Ogre (Ogre Youth)
...
Feral regenerators that haunt wild places. Fire and acid are their only true weakness.
...
Living remnants of a primordial age. Each one is a walking natural disaster.
...
*Inspired by the labyrinth-dwelling beast of Greek myth — a creature of bronze, blood, and endless fury.*
...
*Inspired by the winged spirits of Greek myth — creatures with the bodies of birds and the faces of women, cursed with an endless hunger for the living.*
...
*Inspired by the serpent king of Greek and Roman legend — a creature whose gaze turns flesh to stone.*
...
*Inspired by the hybrid monster of Greek myth — part lion, part goat, part dragon, a single creature that is the sum of three kinds of terror.*
...
*Inspired by the half-horse archers of Greek myth — wild, proud, and deadly at range.*
...
#### Centaur Chieftain (Greater Centaur)
...
Souls bound to rotting flesh by necromantic will, or risen by curses that transcend death. They feel no pain, no fear, no mercy.
...
|------|-|
| Level | 2 |
| STR/DEX/CON/INT/WIS/CHA | +2 / -1 / +2 / -3 / -2 / -2 |
| Max HP | 22 |
| AC | 10 |
| Attack | +2, 1D6+2 (slam) |
| Special | **Fear Immunity** — immune to fear effects.<br>**Undead Fortitude** — when reduced to 0 HP, make a CON save (DC = damage taken). On success, drop to 1 HP instead.<br>**Slow** — cannot take opportunity attacks. |

*A shambling corpse with grey flesh hanging in strips. It groans and reaches with broken fingers, feeling nothing.*

### 4.3 Ghoul

*Inspired by the corpse-eating spirits of Arabian folklore — creatures that lurk in graveyards and feast on the dead.*
...
*Inspired by the revenant warriors of Norse myth — dead heroes who rise from their burial mounds to defend their treasures.*
...
*Inspired by the preserved dead of Egyptian tradition — kings and priests who rose again, bound by ancient curses.*
...
Incorporeal entities that exist between the veil of life and death. They cannot be touched by mortal steel, but they can touch you.

### 5.1 Shade

*A restless spirit, barely more than an echo of the person it once was.*
...
| Max HP | 10 |
| AC | 10 |
| Attack | +2, 1D6 (chill touch) |
| Special | **Incorporeal** — takes half damage from non-magical weapons; immune to non-magical bludgeoning/piercing/slashing.<br>**Fear Immunity** — immune to fear effects.<br>**Sunlight Sensitivity** — while in direct sunlight, the shade's attacks have disadvantage. |
...
*An angry spirit that cannot communicate — only throw.*
...
*Inspired by the ghostly lights of European folklore — spirits that lead travellers to their doom.*

| Stat | |
|------|-|
| Level | 4 |
| STR/DEX/CON/INT/WIS/CHA | -2 / +3 / +0 / +0 / +1 / +1 |
| Max HP | 10 |
| AC | 9 |
| Attack | +5, 2D4 (shock, 30 ft. ranged) |
| Special | **Invisible in Darkness** — the wisp is invisible while in dim light or darkness.<br>**Light Form** — cannot be grappled, restrained, or knocked prone.<br>**Lead Astray** — once per combat, one enemy within 60 ft. makes a WIS save or moves up to its speed toward the wisp (provoking opportunity attacks). |
...
*Inspired by the wailing spirit of Celtic myth — a harbinger of death whose cry cuts through the veil of the living.*
...
### 5.6 Ancestral Guardian

*A protective spirit from cultures that revere their forebears — a ghost that shields the living long after death.*
...
Creatures of pure elemental chaos from beyond the mortal veil. Each demon embodies a primal force of destruction.

### 6.1 Lesser Demon (Fire Imp)
...
*Inspired by the horned ogre-demons of Japanese folklore — shapechanging brutes of immense strength, fond of disguising themselves as priests or travellers.*
...
### 6.4 Greater Demon (Shadow Demon Lord)
...
Magically animated entities of stone, metal, or flesh. They feel nothing, tire never, and obey their creator without question.
...
### 7.3 Greater Golem (Adamantite Golem)
...
The apex predators of the world. Young dragons are encountered in the wild; ancient dragons are campaign-ending threats.

### 8.1 Wyrmling (Young Dragon)
...
### 8.3 Ancient Dragon (Greater Dragon)
...
Divine beings and messengers from the higher planes. They serve gods, guard sacred places, and intervene in mortal affairs only when the balance tips too far toward darkness.

### 9.1 Valkyrie

*Inspired by the battle-maidens of Norse myth — choosers of the slain who descend on shining wings to carry heroes to the halls of the gods.*
...
Creatures of the natural world infused with primal magic. Fey are capricious, ancient, and bound by rules that mortals cannot fully understand.

### 10.1 Leshy

*Inspired by the forest spirit of Slavic folklore — a guardian of the woods who leads hunters astray and speaks in the rustle of leaves.*
...
*Inspired by the water horse of Scottish folklore — a beautiful steed that lures riders onto its back before dragging them to a watery grave.*
...
## Appendix: Creature Level Reference

| Level | Creatures |
|:-----:|-----------|
| **1** | Lesser Goblin, Lesser Kobold, Skeleton, Bandit, Giant Rat |
| **2** | Goblin, Kobold, Zombie, Gladefolk Prowler, Wolf |
| **3** | Greater Goblin, Greater Kobold, Lesser Orc, Lesser Lizard, Mercenary, Dwarf Warrior, Ghoul, Giant Spider, Shade, Elven Archer |
| **4** | Bear, Gladefolk Slinger, Dire Wolf, Will-o'-Wisp |
| **5** | Orc, Lizard Warrior, Wight, Dwarf Berserker, Dark Elf Scout, Lesser Ogre, Harpy, Poltergeist, Centaur Archer |
| **6** | Knight (Human), Gladefolk Elder, Great Stag, Draugr, Kelpie, Elven Mage |
| **7** | Ogre, Dark Elf Mage, Forest Troll, Minotaur, Leshy |
| **8** | Greater Orc, Greater Lizard, Dwarf Lord, Lesser Demon, Clay Golem, Banshee, Wraith, Centaur Chieftain |
| **9** | Greater Dark Elf, Captain (Human), Cave Troll, Mummy, Basilisk, Elven Lord |
| **10** | Greater Ogre, Demon, Hill Giant, Iron Golem, Wyrmling, Oni, Ancestral Guardian |
| **11** | Stone Giant, Chimera, Valkyrie |
| **12** | Lich, Greater Demon, Frost Giant, Adamantite Golem, Adult Dragon |
| **12+ (Boss)** | Ancient Dragon |
