...
FROM (VALUES
    ...
    ('Dominion', 'D4', 'None', 'Spell', 'Mass Haste',              35, 90, 5, 0, 0, 0, 'None',      0, 'Accelerates all party members, boosting turn meter gain.  Inflicts Haste Fatigue on the caster.  Tags: Buff, TM Uplift, Group'),
