...
#
#   BaseDamage  = WeaponDiceRoll + AttributeModifier + FlatDamageBonus
...
Feature: Combat — Damage Formula
    ...
    # BaseDamage = d8(5) + 2 = 7. TypeMultiplier = 1.0. FinalDamage = 7.
    ...
    # BaseDamage = d8(5) + 2 + 2 = 9. FinalDamage = 9.
    ...
    # BaseDamage = d8(5) + 2 = 7. Mitigation = 0. Elemental = +3. FinalDamage = 10.
    ...
    # BaseDamage = d8(5) + 2 = 7. Mitigation = 3. FinalDamage = 7 - 3 = 4.
    ...
    @damage-formula
    # Mitigation can exceed base damage, but final damage is clamped to zero.
    # BaseDamage = d4(1) + 0 = 1 (STR 10, no modifier). Mitigation = 5. 1 - 5 = -4 → 0.
    ...
    # BaseDamage = d8(6) + 2 = 8. 8 * 1.5 = 12.0 → int = 12. FinalDamage = 12.
